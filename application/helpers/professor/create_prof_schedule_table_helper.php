...
function create_table($prof_schedule){
	$schedule = new SimpleXMLElement($prof_schedule);
					    ...
					    <div class="panel-heading " style="'.$panel_lab_style.'"">
					      <h4 class="panel-title">
					        <a data-toggle="collapse" data-parent="#' . $counter_2 . '"
					         href="#pr' . $counter_1 . '" id="course_link">'
					          .  $course_title .
					        '</a>
					      </h4>
					    </div>
					    <div id="pr' . $counter_1 . '" class="panel-collapse collapse in">
...
/* End of file create_prof_schedule_table_helper.php */
/* Location: ./application/helpers/professor/create_prof_schedule_table_helper.php */	
