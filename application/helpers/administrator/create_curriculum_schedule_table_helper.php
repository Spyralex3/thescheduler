...
function create_curriculum_table($courses){
	
	$schedule = new SimpleXMLElement($courses);
...
/* End of file create_curriculum_schedule_table_helper.php */
/* Location: ./application/helpers/administrator/create_curriculum_schedule_table_helper.php */
